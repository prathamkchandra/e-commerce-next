    ...
    return (
        <div className="flex min-h-screen mt-7">
            <div className="w-full max-w-3xl mx-auto flex flex-col lg:flex-row p-3">
                <div>
                    <div className="mb-8 lg:mb-12 cusrsor-pointer" onClick={() => router.push('/')} >
                        <ChevronLeft className="text-gray-500 h-6 w-6 sm:w-8 border-2 rounded-full p-1" />
                    </div>
                    ...
                    <div className='mt-4 sm:mt-5 flex items-center justify-center'>Add commentMore actions
